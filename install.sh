...
mkdir ~/Pentest/Tools/Others/
mkdir ~/Pentest/Tools/GoTools/
...
mv fingerprints.json ~/Pentest/Tools/Others/
...
mv providers-data.csv ~/Pentest/Tools/Others/
...
rm README.md
rm LICENSE.txt
mv aquatone ~/Pentest/Tools/GoTools/bin
rm aquatone_linux_amd64_1.7.0.zip

# SMUGGLER
mkdir ~/Pentest/Tools/Smuggler/
wget https://raw.githubusercontent.com/gwen001/pentest-tools/master/smuggler.py
mv smuggler.py ~/Pentest/Tools/Smuggler/

# GITHUB ENDPOINT
mkdir ~/Pentest/Tools/GitHubTool/
wget https://raw.githubusercontent.com/gwen001/github-search/master/github-endpoints.py
mv github-endpoints.py ~/Pentest/Tools/GitHubTool
